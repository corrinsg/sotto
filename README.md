...
| **PDF (text-based)** | Dynamic column detection covers banks that use "Paid out"/"Paid in", "Money out"/"Money in", "Debit"/"Credit", "In"/"Out", or a dedicated "Type" column. Tested against HSBC and Lloyds-shaped layouts. |
...
- **Vitest** for unit tests (68 tests across parser, CSV, categorisation, and store dedupe logic)
